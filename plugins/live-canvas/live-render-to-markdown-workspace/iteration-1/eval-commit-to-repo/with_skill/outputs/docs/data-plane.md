...
flowchart LR
  ...
  click svc_auth "./platform-services.md#svc_auth" "Open Platform services region"
  click svc_billing "./platform-services.md#svc_billing" "Open Platform services region"
  click svc_orders "./platform-services.md#svc_orders" "Open Platform services region"
