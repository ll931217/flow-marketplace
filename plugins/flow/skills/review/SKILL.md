---
name: review
description: Multi-dimensional code review using parallel team-reviewers after implementation. Analyzes security, performance, architecture, testing, and accessibility. Auto-fixes critical findings. Use after implementation is complete, before cleanup.
---
