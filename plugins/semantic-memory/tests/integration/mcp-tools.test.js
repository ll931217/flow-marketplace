...
describe('MCP Tools Integration', () => {
    ...
    describe('Index.ts tool registration', () => {
        it('should register memory_add tool', async () => {
            const indexContent = await import('fs').then(fs => fs.promises.readFile('./src/index.ts', 'utf-8'));
    ...
    describe('Database schema', () => {
        it('should include memories table creation', async () => {
            const dbContent = await import('fs').then(fs => fs.promises.readFile('./src/database.ts', 'utf-8'));
